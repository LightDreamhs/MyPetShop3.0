...
|------|---------|---------|------|
| **CPU** | 2核 | 2核 | 5人以内完全够用 |
| **内存** | 2GB | 2GB | 系统已优化，2G足够 |
| **磁盘** | 40GB | 60GB | 根据数据量选择 |
| **操作系统** | Ubuntu 20.04+ / CentOS 7+ | Ubuntu 22.04 LTS | 推荐Ubuntu |

**💡 性能参考：**
- 2GB内存可支持：每天100单、5-10人同时在线、10万条记录
- 如需更高配置：查看 `2G-SERVER-GUIDE.md` 的详细性能分析
...
**💡 配置建议：**
- 单店试用、每天<50单：**2核2G** 足够（约60-100元/年）
- 小规模使用、每天<100单：**2核4G** 更稳定（约100-150元/年）
- 多店连锁、数据分析：4核8G或更高
